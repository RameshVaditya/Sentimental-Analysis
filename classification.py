...
test_tweetssad=read_tweets('sad_test.txt','negative')
...
print('Total accuracy of happy: %f%% (%d/10).' % (accuracy / total * 100, accuracy))

for tweet in test_tweetssad:
    if classify_tweet(tweet[0])!=tweet[1]:
        accuracy-= 1

print('Total accuracy of sad: %f%% (%d/10).' % (accuracy / total * 100, accuracy))
